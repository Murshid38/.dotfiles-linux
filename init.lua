...
-- tokyonight theme
-- mkdir -p ~/.config/nvim/pack/colors/start
-- cd ~/.config/nvim/pack/colors/start
-- git clone https://github.com/folke/tokyonight.nvim.git
-- enable true-color support:
vim.o.termguicolors = true

-- initialize the theme (optional but lets you configure options):
...
-- Force Telescope to use editor's colorscheme
vim.api.nvim_create_autocmd("FileType", {
...
-- Set Telescope highlight groups to match your colorscheme
...
end, { desc = "Telescope: project find files" })
